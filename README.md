...
| jd.union.open.activity.query(活动查询接口)   | \$client->activity->query()   |
| jd.union.open.coupon.gift.get(礼金创建)   | \$client->gift->get()   |
| jd.union.open.coupon.gift.stop(礼金停止)   | \$client->gift->stop()   |
| jd.union.open.statistics.giftcoupon.query(礼金效果数据)   | \$client->gift->query()   |
